...
def draw_face_box_and_landmarks(image, box, landmarks, box_color=(0, 255, 0), landmark_color=(0, 0, 255), thickness=2):
    """
    Vẽ hộp giới hạn và 5 điểm landmark lên ảnh.
    Args:
        image: Ảnh đầu vào dạng numpy array.
        box: Danh sách [x1, y1, x2, y2] (tọa độ trái trên, phải dưới).
        landmarks: Danh sách 5 điểm [x1, y1, x2, y2, ..., x5, y5].
        box_color: Màu hộp (BGR).
        landmark_color: Màu điểm landmark (BGR).
    ...
    for i in range(0, len(landmarks), 2):
        ...
        cv2.circle(image, (x, y), 2, landmark_color, -1)
